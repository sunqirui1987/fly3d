...
func (e *Dispatcher) Initialize() {
	e.events = make(map[string][]interface{})
}

// On set new listener
func (e *Dispatcher) On(name string, fn interface{}) error {
	e.Lock()
	defer e.Unlock()
...
func (e *Dispatcher) Emit(name string, params ...interface{}) error {
	e.RLock()
	defer e.RUnlock()
...
func (e *Dispatcher) call(fn interface{}, params ...interface{}) (stopped bool, err error) {
...
func (e *Dispatcher) Has(name string) bool {
	e.RLock()
	defer e.RUnlock()
	_, ok := e.events[name]
	return ok
...
func (e *Dispatcher) Remove(names ...string) {
	e.Lock()
	defer e.Unlock()
	if len(names) > 0 {
