...
func (l *Label) Color() canvas.Color {
	return l.color
}

// SetColor() sets the label color
func (l *Label) SetColor(color canvas.Color) {
	l.color = color
}
...
func (l *Label) PreferredSize(self Widget, ctx *canvas.Context) (int, int) {
	if l.caption == "" {
		return 0, 0
	}
...
func (l *Label) Draw(self Widget, ctx *canvas.Context) {
