...
func (b *ExpandBoxLayout) OnPerformLayout(widget nanogui.Widget, ctx *canvas.Context) {
...
func (b *ExpandBoxLayout) PreferredSize(widget nanogui.Widget, ctx *canvas.Context) (int, int) {
	fW, fH := widget.FixedSize()
	var containerSize [2]int
	if fW > 0 {
		containerSize[0] = fW
...
func (g *ExpandListLayout) OnPerformLayout(widget nanogui.Widget, ctx *canvas.Context) {
...
func (g *ExpandListLayout) PreferredSize(widget nanogui.Widget, ctx *canvas.Context) (int, int) {
	_, _, totalWidth, totalHeight := g.computeSize(widget, ctx)
	return totalWidth, totalHeight
}

func (g *ExpandListLayout) computeSize(widget nanogui.Widget, ctx *canvas.Context) (widths, heights []int, totalWidth, totalHeight int) {
