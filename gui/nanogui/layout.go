...
type Layout interface {
	OnPerformLayout(widget Widget, ctx *canvas.Context)
	PreferredSize(widget Widget, ctx *canvas.Context) (int, int)
	String() string
}
...
func (b *BoxLayout) OnPerformLayout(widget Widget, ctx *canvas.Context) {
...
func (b *BoxLayout) PreferredSize(widget Widget, ctx *canvas.Context) (int, int) {
...
func (g *GroupLayout) OnPerformLayout(widget Widget, ctx *canvas.Context) {
	height := g.margin
...
func (g *GroupLayout) PreferredSize(widget Widget, ctx *canvas.Context) (int, int) {
	height := g.margin
	width := g.margin * 2
...
func (g *GridLayout) OnPerformLayout(widget Widget, ctx *canvas.Context) {
...
func (g *GridLayout) PreferredSize(widget Widget, ctx *canvas.Context) (int, int) {
	grid := g.computeLayout(widget, ctx)
...
func (g *GridLayout) computeLayout(widget Widget, ctx *canvas.Context) [][]int {
	axis1 := int(g.orientation)
	axis2 := (int(g.orientation) + 1) % 2
	numChildren := widget.ChildCount()
	visibleChildren := 0
...
func (a *AdvancedGridLayout) OnPerformLayout(widget Widget, ctx *canvas.Context) {
...
func (a *AdvancedGridLayout) PreferredSize(widget Widget, ctx *canvas.Context) (int, int) {
	grid := a.computeLayout(widget, ctx)
	sizeW := a.margin * 2
	sizeH := a.margin * 2
...
func (a *AdvancedGridLayout) computeLayout(widget Widget, ctx *canvas.Context) [][]int {
