...
package glutil // import "github.com/suiqirui1987/fly3d/gl/glutil"
...
func CreateProgram(vertexSrc, fragmentSrc string) (gl.Program, error) {
	...
	if err != nil {
		return gl.Program{}, fmt.Errorf("loadShader Vertex Failed %s", err)
	}
	fragmentShader, err := loadShader(gl.FRAGMENT_SHADER, fragmentSrc)
	if err != nil {
		gl.DeleteShader(vertexShader)
		return gl.Program{}, fmt.Errorf("loadShader Fragment Failed %s", err)
	}
